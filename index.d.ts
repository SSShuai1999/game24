...
declare namespace ht {
    ...
    export class List {
        ...
        /**
         * 
         * @param args 构造函数可传入 ht.Node[] 和 ht.List，也可以加入单个 object 元素
         */
        constructor(args?: ht.Node[] | ht.List | Object): ht.List
         ...
         * @param index 指定位置
         */
        add<T extends ht.Node>(item: T, index?: number): number | Array<any>;

        /**
         * 将一批元素加入到当前集合中
         * @param { ht.List[] | ht.List } array 元素数组或集合
         */
        addAll<T extends ht.Node>(array: T[] | ht.List): void;
        ...
        /**
         * 判断当前集合是否包含参数元素
         * @param { ht.Node } item 是否包含此元素
         */
        contains(item: ht.Node): boolean

        /**
         * 提供一个回调函数遍历此集合
         * @param { (p: ht.Node) => void } func 遍历函数
         * @param { T } [scope] 函数域
         * @example 
         ...
         * });
         */
        each<T = any>(func: (p: ht.Node) => void, scope?: T): void;

        /**
         * 返回索引位置的的元素
         * @param {number} index 索引
         * @return { ht.Node } 处于索引位置的元素
         */
        get(index: number): ht.Node;
         ...
         */
        getSuperClass<T = any>(): T;

        /**
         * 获得参数元素的索引
         * @param { ht.Node } item 元素
         * @return { number } 元素的索引
         */
        indexOf(item: ht.Node): number;
        ...
        /**
         * 将参数元素从集合中删除
         * @param { ht.Node } item 要删除的元素
         * @return {number} 要删除的元素的索引
         */
        remove(item: ht.Node): number;

        /**
         * 删除索引位置的元素
         * @param { number } index 要删除的索引
         * @return { ht.Node } 删除的元素
         */
        removeAt(index: number): ht.Node;
         ...
         * });
         */
        reverseEach<T = any>(func: (p: ht.Node) => void, scope?: T): void;

        /**
         * 设置索引处的元素
         * @param { number } index 索引，如果此索引处存在元素则将其替换
         * @param { ht.Node } item 新元素
         */
        set(index: number, item: ht.Node): void;
         ...
         * @return { ht.List } 新集合
         */
        slice(start: number, end?: number): ht.List;

        /**
         * 根据参数函数将元素排序
         * @param { (p1: T, p2: T) => boolean } sortFunc 排序函数
         * @example 
         ...
         * @return { ht.List } 自身
         */
        sort<T = any>(sortFunc: (p1: T, p2: T) => boolean): ht.List;

        /**
         * 以 matchFunc 为过滤函数构建新的元素数组
         * @param { (p: ht.Node) => boolean } [matchFunc] 过滤函数
         * @param { T } [scope] 函数域
         * @example 
         ...
         * @return { ht.Node[] } 元素数组
         */
        toArray<T = any>(mathFunc?: (p: ht.Node) => boolean, scope?: T): ht.Node[];
         ...
         * @return {List} 元素集合
         */
        toList<T = any>(mathFunc?: (p: ht.Node) => boolean, scope?: T): ht.List
    ...
    export class Node extends Data {
        ...
        */
         ...
         */
        setAnchor(x: Point | number | Array<number>, y?: number | boolean, rectStable?: boolean): void;
    ...
    export class SelectionModel {
         ...
         * @param {boolean} [ahead] 是否将当前监听器插入到监听器列表开头
         */
        addPropertyChangeListener(listener: Function, scope?: any, ahead?: boolean): void;
         ...
         * });
         */
        addSelectionChangeListener(listener: Function, scope?: any, ahead?: boolean): void;
    ...
    export class DataModel {
         ...
         * @param ahead 
         */
        addSerializeListener(listener: Function, scope?: any, ahead?: boolean): void;
         ...
         * });
         */
        addDataModelChangeListener(listener: Function, scope?: any, ahead?: boolean): void;
         ...
         * });
         */
        addDataPropertyChangeListener(listener: Function, scope?: any, ahead?: boolean): void;
         ...
         * });
         */
        addHierarchyChangeListener(listener: Function, scope?: any, ahead?: boolean): void;
         ...
         * });
         */
        addIndexChangeListener(listener: Function, scope?: any, ahead?: boolean): void;
         ...
         * @param {boolean} [ahead] 是否将当前监听器插入到监听器列表开头
         */
        addPropertyChangeListener(listener: Function, scope?: Object, ahead?: boolean): void;
         ...
         */
        deserialize(json: string | Object, rootParent?: Data, setId?: boolean): List;
    ...
    export class JSONSerializer{
         ...
         */
        deserialize(json: string | Object, rootParent?: Data, options?: boolean): void;
    ...
    namespace graph {
        ...
        export class GraphView {
             ...
             * });
             */
            addInteractorListener(listener: Function, scope?: any, ahead?: boolean): void;
             ...
             * @param notZoomIn 
             */
            fitSelection(padding?: number, anim?: boolean|AnimOption, notZoomIn?: boolean): AnimInstance;
             ...
             */
            fitData(data: Data, anim?: boolean, padding?: number, notZoomIn?: boolean, retry?: boolean): void;
             ...
             * @return {Data} 点下的图元
             */
            getDataAt(pointOrEvent: Object, filter?: Function, range?: number): Data | null;
             ...
             * @return {Object} 图元和part信息
             */
            getDataInfoAt(pointOrEvent: MouseEvent|Point, filter?: Function, range?: any): Object;
             ...
             * @return {List}
             */
            getDatasInRect(rect: Rect, intersects?: boolean, selectable?: boolean): List;
             ...
             * @param type 
             */
            isSourceTargetEditable(edge: Edge, data: Node | Edge, type?: string): boolean;
             ...
             * @param retry 
             */
            makeCenter(data: Data, anim?: boolean | AnimOption, retry?: boolean): AnimInstance;
             ...
             * @param offsetY 垂直移动值
             */
            moveDatas(datas: Array<Data> | List, offsetX: number, offsetY?: number): void;
            ...
            onCSGBoxDoubleClicked(csgBox: CSGBox, event: MouseEvent, part?: string): void;

            onDoorWindowDoubleClicked(csgBox: CSGBox, event: MouseEvent, part?: string): void;
            ...
            serializeProperty(name: string, value: any, serliazer: JSONSerializer): any;
    ...
    namespace graph3d {
        ...
        export class Graph3dView {
             ...
             * });
             */
            addInteractorListener(listener: Function, scope?: Object, ahead?: boolean): void;
             ...
             * @param {boolean} [ahead] 是否将当前监听器插入到监听器列表开头
             */
            addViewListener(listener: Function, scope?: Object, ahead?: boolean): void;
             ...
             * @param part 
             */
            checkDoubleClickOnNote(event: MouseEvent, data: Data, part: string): boolean;

            checkDoubleClickOnRotation(event: MouseEvent, data: Data, part: string): boolean;
             ...
             * @param params 其它参数
             */
            firePropertyChange(property: string, oldValue: any, newValue: any, equalFunc?: Function, params?: any): void;
             ...
             * @param params 其它参数
             */
            fp(property: string, oldValue: any, newValue: any, equalFunc?: Function, params?: any): void;
             ...
             */
            getHitPosition(eventOrPoint: any, ponit?: number[], normal?: number): number[];
             ...
             * @param filter 
             */
            intersectObjects(pointOrEventOrRay: any, nodes: Node[], filter?: Function): Object;
             ...
             * @param {Object} part 区域
             */
            onSubGraphDoubleClicked(subGraph: SubGraph, event: Object, part: Object): void;
             ...
             */
            pan(dx: number, dy: number, anim?: boolean, firstPersonMode?: boolean): void;
            ...
            renderEnvToCube(width: number, height: number, side: string, textureWidth: number): void;
             ...
             */
            rotate(leftRight: number, upDown: number, anim?: boolean, firstPersonMode?: boolean): void;
            ...
            setViewport(gl: any, x: number, y: number, width: number, height: number): void;
             ...
             */
            moveCamera(eye: Array<number>, center: Array<number>, anim?: boolean | AnimOption): AnimInstance;
    ...
    namespace Default {
         ...
         */
        function setImage(name: String, img?: HTMLImageElement | HTMLCanvasElement | String | Object): void;
         ...
         * @param {HTMLImageElement|HTMLCanvasElement|String|Object} img img、canvas对象或图片url或base64字符串或矢量对象
         */
        function setImage(name: String, width?: number, height?: number, img?: HTMLImageElement | HTMLCanvasElement | String | Object): void;
         ...
         */
        function getImage(name: String, color?: String): HTMLImageElement | HTMLCanvasElement | Object;
         ...
         */
        function callLater(func: Function, scope?: Object, args?: Array<any>, delay?: number): void;
         ...
         * });
         */
        function def(className: String | Object, superClass: Object, methods: Object): void;
         ...
         */
        function drawText(g: CanvasRenderingContext2D, value: String, font: String, color: String, x: number, y: number, width: number, height: number, align: number, vAlign: number): void;
         ...
         * @return {Object} 逻辑点坐标
         */
        function getLogicalPoint(e: MouseEvent, view: Object, translateX: number, translateY: number, zoomX: number, zoomY: number): Object;
         ...
         */
        function toBoundaries(points: Array<Object>, segments: Array<Object>, resolution: number): Array<number>;
         ...
         * @param {color} color 染色
         */
        function drawCenterImage(g: CanvasRenderingContext2D, img: HTMLImageElement | HTMLCanvasElement | Object, x: number, y: number, data?: Data, view?: Object, color?: String): void;
         ...
         * @param {color} color 染色
         */
        function drawStretchImage(g: CanvasRenderingContext2D, img: HTMLImageElement | HTMLCanvasElement | Object, stretch: String, x: number, y: number, w: number, h: number, data?: Data, view?: Object, color?: String): void;
         ...
         */
        function toCanvas(image: HTMLImageElement | Object, width: number, height: number, stretch: String, data?: Data, view?: Object, color?: String): HTMLCanvasElement;
         ...
         */
        function createElement(tagName: String, borderColor: String, font: String, value: String): Element;
         ...
         */
        function drawImage(g: CanvasRenderingContext2D, image: HTMLImageElement | HTMLCanvasElement | Object, x: number, y: number, width: number, height: number, data?: Data, view?: Object, blendColor?: String): void;
         ...
         * 构建光滑球体模型
         */
        function createSmoothSphereModel(hResolution: number, vResolution: number, hStart: number, hArc: number, vStart: number, vArc: number, radius: number): Object;

        /**
         * 构建球体模型
         */
        function createSphereModel(side: number, sideFrom: number, sideTo: number, from: number, to: number, resolution: number): Object;

        /**
         * 构建光滑圆锥体模型
         */
        function createSmoothConeModel(bottom: number, resolution: number, start: number, arc: number, radius: number): Object;

        /**
         * 构建圆锥体模型
         */
        function createConeModel(side: number, sideFrom: number, sideTo: number, from: number, to: number, bottom: number): Object;

        /**
         * 构建光滑圆柱体模型
         */
        function createSmoothCylinderModel(resolution: number, top: number, bottom: number, topRadius: number, bottomRadius: number, start: number, arc: number, height: number): Object;

        /**
         * 构建圆柱体模型
         */
        function createCylinderModel(side: number, sideFrom: number, sideTo: number, from: number, to: number, top: number, bottom: number): Object;

        /**
         * 构建光滑圆环体模型
         */
        function createSmoothTorusModel(radius: number, tubeRadius: number, hResolution: number, vResolution: number, start: number, arc: number): Object;

        /**
         * 构建圆环体模型
         */
        function createTorusModel(side: number, sideFrom: number, sideTo: number, from: number, to: number, radius: number, resolution: number): Object;

        /**
         * 根据xz平面多边形，挤压形成3D模型
         */
        function createExtrusionModel(array: Array<number>, segments: Array<Object>, top: number, bottom: number, resolution: number, repeatUVLength: number, tall: number, elevation: number): Object;

        /**
         * 根据xy平面的曲线，环绕一周形成光滑3D模型
         */
        function createSmoothRingModel(array: Array<number>, segments: Array<Object>, vResolution: number, start: number, arc: number, hResolution: number): Object;

        /**
         * 根据xy平面的曲线，环绕一周形成3D模型
         */
        function createRingModel(array: Array<number>, segments: Array<Object>, resolution: number, top: number, bottom: number, side: number, sideFrom: number, sideTo: number, from: number, to: number): Object;
        ...
        */
         ...
         */
        function drawBorder(g: CanvasRenderingContext2D, borderColor: string, x: number, y: number, width: number, height: number, borderWidth: number): void;
         ...
         * @return: 
         */
        function drawRoundRect(g: CanvasRenderingContext2D, x: number, y: number, width: number, height: number, topLeftRadius?: number, topRightRadius?: number, bottomLeftRadius?: number, bottomRightRadius?: number): void;
         ...
         * @param h 绘制的高度
         */
        function createGradient(g: CanvasRenderingContext2D, type: string, background: string, gradientColor: string, x: number, y: number, w: number, h: number): CanvasGradient;
         ...
         * @param value 值
         */
        function setPropertyValue(data: Data, type: string, name: string, value: any): void;
         ...
         * @param radius 拐角弧度，
         */
        function toRoundedCorner(listOrNode: List | Shape | Array<any>, radius: number): any;
         ...
         */
        function setConnectAction(actionType: string, action: ConnectActionFunc, extraInfo?: ConnectActionExtraInfo): void;
         ...
         */
        function xhrLoad(urls: string | [], callback: Function, option?: Object): void;
    ...
    namespace Math {
        ...
        export class CubicBezier {
           ...
           * @constructor
           */
          constructor(v1?: Vector2 | Vector3, v2?: Vector2 | Vector3, v3?: Vector2 | Vector3, v4?: Vector2 | Vector3);
        ...
        export class Ray {
           ...
           * @param {Vector3} target 结果将复制到该向量中
           */
          intersectTriangle(a: Vector3, b: Vector3, c: Vector3, cull: Boolean, target: Vector3): Vector3;
